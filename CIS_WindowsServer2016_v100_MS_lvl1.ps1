...
ForEach ($Module in $Modules) {
    ...
    Catch {
        Write-Error $_
        Throw "Failed to install $Module, cannot continue."
    }    
}

#DSC Configuration for CIS Level 1 hardening standards for Member Servers
Configuration CIS_WindowsServer2016_v100_MS_lvl1 {
    ...
    Node $NodeName {
        ...
        SecurityOption AccountSecurityOptions {
            ...
            Interactive_logon_Message_text_for_users_attempting_to_log_on = '<Replace with organizational requirements>'

            # 2.3.7.5 (L1) Configure 'Interactive logon: Message title for users attempting to log on'
            Interactive_logon_Message_title_for_users_attempting_to_log_on = '<Replace with organizational requirements>'
